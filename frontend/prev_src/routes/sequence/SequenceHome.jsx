          ...
          return (
            <div key={c.id}>
              ...
              <button onClick={() => refs.current[c.id]?.click()}
                ...
                <div style={{ fontSize:14, fontWeight:800, color:'#0f2460' }}>{c.label}</div>
                <div style={{ fontSize:11.5, color:'#5a7ec0', lineHeight:1.45 }}>{c.desc}</div>
                <div style={{ fontSize:10, color:c.color, fontWeight:600, marginTop:'auto', paddingTop:6 }}>
