...
export default function MSAViewer({ sequences: seqsProp, onClose }) {
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', overflow:'hidden' }}>
      <MSAToolbar onClose={onClose}
        cellW={cellW} setCellW={setCellW}
        colStart={colStart} setColStart={setColStart}
        alnLen={alnLen} visibleCols={visibleCols}
        seqType={seqType} hoverCol={hoverCol}
        conservation={conservation} consensus={consensus}/>
      ...
      <div style={{ display:'flex', flex:1, overflow:'hidden', minHeight:0 }}>
        ...
        <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minWidth:0 }}>
          ...
          <div style={{ padding:'4px 8px', background:'var(--bg2)', borderTop:'1px solid var(--border)', flexShrink:0 }}>
        ...
        {/* Sidebar — same CommonSidebar base, closable */}
        <MSASidebar seqs={seqs} width={260}/>
      </div>
    </div>
  )
}
