  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', height:'100%', background:'#f0f5ff' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:12, padding:'8px 16px', background:'#1a3faa', flexShrink:0 }}>
        <span style={{ fontSize:18, fontWeight:800, color:'#fff', fontFamily:'"IBM Plex Sans",sans-serif' }}>BLAST Results</span>
        <span style={{ fontSize:12, color:'#a0c0ff' }}>{hits.length.toLocaleString()} HSPs · {queries.length} query/queries</span>
